...
const DynamicForm: React.FC<Props> = ({ schema, initialData, onAction, onFormDataChange, validationErrors, configIssueOverride }) => {
  ...
  return (
    <Box sx={{ width: '100%' }} data-testid="dynamic-form">
      <Card
        elevation={0}
        sx={{
          border: "none",
      ...
      >
        <CardContent sx={{ p: { xs: 2, md: 3 } }}>
          ...
          >
            <Typography variant="h5" gutterBottom sx={{ mb: 0 }} data-testid="form-title">
              {t("form.title", {
                defaultValue: activeSchema.formMeta.formName,
              })}
            </Typography>
            <FormControl size="small" sx={{ minWidth: 160 }} data-testid="language-selector">
          ...
          <Box data-testid="instructions-container" 
          sx={{
          ...
          sx={{ display: 'flex', flexDirection: 'column', gap: 1 }}>
            {fields.length > 0 ? (
              ...
              <Typography color="warning.main" sx={{ py: 2, textAlign: 'center' }} data-testid="no-fields-warning">
          ...
          >
            <DialogTitle data-testid="failure-dialog-title">
              {t("dialog.failureTitle", {
                defaultValue: activeSchema.failureResponse.title,
              })}
            </DialogTitle>
            <DialogContent data-testid="failure-dialog-content">
              <Typography>
